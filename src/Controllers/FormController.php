...
----------------------*/
namespace billiemead\FormBuilder\Controllers;

use App\Http\Controllers\Controller;
use billiemead\FormBuilder\Events\Form\FormCreated;
use billiemead\FormBuilder\Events\Form\FormDeleted;
use billiemead\FormBuilder\Events\Form\FormUpdated;
use billiemead\FormBuilder\Helper;
use billiemead\FormBuilder\Models\Form;
use billiemead\FormBuilder\Requests\SaveFormRequest;
...
class FormController extends Controller
{
     ...
     *
     * @param  billiemead\FormBuilder\Requests\SaveFormRequest $request
     * @return \Illuminate\Http\Response
     */
