                                ...
                                <div class="form-group">
                                    ...
                                    <select name="allows_edit" id="allows_edit" class="form-control" required="required">
                                        <option value="0" @if($form->allows_edit == 0) selected @endif>
                                            {{ translate('No (submissions are final)') }}
                                        </option>
                                        <option value="1" @if($form->allows_edit == 1) selected @endif>
                                            {{ translate('Yes (allow users to edit their submissions)') }}
                                        </option>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="alert alert-info" role="alert">
                                    ...
                                    {{ translate('Click on or Drag and drop components onto the main panel to build your form content.')}}
                                </div>
