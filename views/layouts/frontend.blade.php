@extends(config('formbuilder.layout_file', 'frontend.layouts.app'))
...
@prepend(config('formbuilder.layout_js_stack', 'scripts'))
	...
	<script src="{{ static_asset('vendor/formbuilder/js/footable/js/footable.js') }}" defer></script>
...
@prepend(config('formbuilder.layout_css_stack', 'styles'))
	<link rel="stylesheet" type="text/css" href="{{ static_asset('vendor/formbuilder/js/footable/css/footable.standalone.css') }}">
