...
@prepend(config('formbuilder.layout_js_stack', 'scripts'))
	...
	<script src="{{ static_asset('vendor/formbuilder/js/jquery-formbuilder/form-builder.min.js') }}" defer></script>
	<script src="{{ static_asset('vendor/formbuilder/js/jquery-formbuilder/form-render.min.js') }}" defer></script>
